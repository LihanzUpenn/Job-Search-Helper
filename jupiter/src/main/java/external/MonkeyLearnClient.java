...
public class MonkeyLearnClient {
	private static final String API_KEY = "f35eaba609b8bb2d00970f6208d08c14e9390441";
	/*75afd1fbbc76069bdcd619d48cc238d2f26fb2f8
	...
	*/
	...
	ExtraParam[] extraParams = {new ExtraParam("max_keywords", "3")}; //返回前3个
	...
	try {
		...
		return getKeywords(resultArray);  //把从 MonkeyLearning 得来的keywords拿来分析
	...
	private static List<List<String>> getKeywords(JSONArray mlResultArray) {
		...
		System.out.println(mlResultArray);
